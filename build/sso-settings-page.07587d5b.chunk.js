"use strict";(self.webpackChunkescaperoom=self.webpackChunkescaperoom||[]).push([[302],{40316:(Q,y,e)=>{e.r(y),e.d(y,{SingleSignOn:()=>l,default:()=>r});var t=e(67294),d=e(68547),a=e(85018),x=e(17034),P=e(67838),$=e(49066),F=e(29728),A=e(185),B=e(7681),D=e(75515),C=e(20707),W=e(91216),Z=e(82562),L=e(11276),z=e(74571),j=e(97132),k=e(18446),H=e.n(k),G=e(38683),b=e(48474),M=e(87751),g=e(53209);const J=g.Ry().shape({autoRegister:g.Xg().required(d.translatedErrors.required),defaultRole:g.nK().when("autoRegister",(n,o)=>n?o.required(d.translatedErrors.required):o.nullable())}),f={...M.Z.settings.sso,readRoles:M.Z.settings.roles.read},l=()=>{const{formatMessage:n}=(0,j.useIntl)(),{isLoading:o,allowedActions:{canUpdate:i,canReadRoles:E}}=(0,d.useRBAC)(f),[{formErrors:u,initialData:S,isLoading:p,modifiedData:h,showHeaderButtonLoader:m},O,{handleChange:v,handleSubmit:T}]=(0,b.G4)((0,G.IF)("providers/options"),J,()=>{},["autoRegister","defaultRole"]),{roles:K}=(0,b.bF)(E);(0,d.useFocusWhenNavigate)();const N=o||p;(0,t.useEffect)(()=>{if(u.defaultRole){const s='[name="defaultRole"]';document.querySelector(s).focus()}},[u]);const I=H()(S,h);return t.createElement(x.A,null,t.createElement(d.SettingsPageTitle,{name:"SSO"}),t.createElement(A.o,{tabIndex:-1},t.createElement("form",{onSubmit:s=>{if(I){s.preventDefault();return}T(s)}},t.createElement(P.T,{primaryAction:t.createElement(F.z,{"data-testid":"save-button",disabled:I,loading:m,startIcon:t.createElement(a.Z,null),type:"submit",size:"L"},n({id:"global.save",defaultMessage:"Save"})),title:n({id:"Settings.sso.title",defaultMessage:"Single Sign-On"}),subtitle:n({id:"Settings.sso.description",defaultMessage:"Configure the settings for the Single Sign-On feature."})}),t.createElement($.D,null,N?t.createElement(d.LoadingIndicatorPage,null):t.createElement(B.K,{spacing:4,background:"neutral0",padding:6,shadow:"filterShadow",hasRadius:!0},t.createElement(D.Z,{variant:"delta",as:"h2"},n({id:"global.settings",defaultMessage:"Settings"})),t.createElement(L.r,{gap:4},t.createElement(z.P,{col:6,m:6,s:12},t.createElement(C.s,{"aria-label":"autoRegister","data-testid":"autoRegister",disabled:!i,checked:h.autoRegister,hint:n({id:"Settings.sso.form.registration.description",defaultMessage:"Create new user on SSO login if no account exists"}),label:n({id:"Settings.sso.form.registration.label",defaultMessage:"Auto-registration"}),name:"autoRegister",offLabel:n({id:"app.components.ToggleCheckbox.off-label",defaultMessage:"Off"}),onLabel:n({id:"app.components.ToggleCheckbox.on-label",defaultMessage:"On"}),onChange:s=>{v({target:{name:"autoRegister",value:s.target.checked}})}})),t.createElement(z.P,{col:6,m:6,s:12},t.createElement(W.P,{disabled:!i,hint:n({id:"Settings.sso.form.defaultRole.description",defaultMessage:"It will attach the new authenticated user to the selected role"}),error:u.defaultRole?n({id:u.defaultRole.id,defaultMessage:u.defaultRole.id}):"",label:n({id:"Settings.sso.form.defaultRole.label",defaultMessage:"Default role"}),name:"defaultRole",onChange:s=>{v({target:{name:"defaultRole",value:s}})},placeholder:n({id:"components.InputSelect.option.placeholder",defaultMessage:"Choose here"}),value:h.defaultRole},K.map(({id:s,name:R})=>t.createElement(Z.W,{key:s,value:s.toString()},R))))))))))},r=()=>t.createElement(d.CheckPagePermissions,{permissions:f.main},t.createElement(l,null))},20707:(Q,y,e)=>{e.d(y,{s:()=>f});var t=e(67294),d=e(71893),a=e(45697),x=e(75228),P=e(14085),$=e(54574),F=e(64777),A=e(63428),B=e(96404),D=e(7681),C=e(11047),W=e(39785),Z=e(15585),L=e(75515),z=e(63237),j=e(41580),k=e(88262);const H=d.default.label`
  position: relative;
